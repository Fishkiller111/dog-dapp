...
exports.withdrawBalance = trpc_1.protectedProcedure.mutation(function (_a) {
    var user = _a.ctx.user;
    return __awaiter(void 0, void 0, void 0, function () {
        var withdrawableScores, totalWithdrawable_1, minWithdrawAmount, scoreIds_1, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 3, , 4]);
                ...
                case 1:
                    ...
                    totalWithdrawable_1 = withdrawableScores.reduce(function (sum, score) { return sum + score.Token; }, 0);
                    minWithdrawAmount = Number(process.env.MIN_WITHDRAW_AMOUNT || 21) || 21;
                    if (totalWithdrawable_1 < minWithdrawAmount) {
                        throw new Error("Insufficient balance. Minimum withdrawal amount is 21 tokens.");
                    }
                    console.log("User " + user.id + " is withdrawing " + totalWithdrawable_1 + " tokens");
                    ...
                    return [4 /*yield*/, database_1.db.$transaction(function (prisma) { return __awaiter(void 0, void 0, void 0, function () {
                            var userInfo, walletAddress, gatewayUrl;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 1:
                                        // 首先将状态改为提现中
                                        _a.sent();
                                        return [4 /*yield*/, database_1.db.user.findUnique({
                                                where: {
                                                    id: user.id
                                                },
                                                select: {
                                    ...
                                    case 2:
                                        ...
                                        gatewayUrl = process.env.GATEWAY_URL || "http://localhost:5200";
